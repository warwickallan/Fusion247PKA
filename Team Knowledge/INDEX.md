...
- **[[Team Knowledge/Templates/INDEX|Templates]]** — copy-and-edit canonical SHAPES. Every PKM and Client Delivery entity, plus the estate's own operating artefacts: the **[[Templates/wayfinder-plan|Wayfinder plan]]** (mandatory before any build begins), the [[Templates/work-order|Work Order]] and the [[Templates/veritas-receipt|Veritas receipt]]. A template defines shape only; the rule requiring the artefact lives in `CLAUDE.md` or a Guideline.
