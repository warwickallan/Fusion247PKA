...
**T-04 (Opus).** T-01, T-02, T-03, T-07, T-09, T-10, T-11, T-13, **T-14** all resolved
2026-07-31 (see §10 write-back).

**T-04 is now the whole frontier**, and it is the gate on everything left: T-05, T-06 and
T-12 all depend on it directly, and T-08 (the dogfood that is the *real* acceptance test,
M4) needs it as its last outstanding dependency. The rotation half of this build is
complete; the **advice** half has not started.
