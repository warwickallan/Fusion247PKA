...
- **Phase 5 — teardown review candidate — PARTIAL (2026-08-02). Built and self-verified; the independent-review GATE IS NOT MET.**
  ...
  - **Next action on resume:** SHIT TO DO #9 (pathspec in `gitEvidence.mjs`), then re-run the teardown review untruncated, twice, then Phase 6.
