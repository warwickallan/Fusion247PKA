...
**C-1..C-9, C-11..C-15** · shopping projectors · general Builds/System projections · generic Telegram attention loop · withheld-capability demo · attention history · documentation privacy scanning · YouTube capture · unrelated Cockpit visual polish · replacement-machine disaster recovery · full IDEA-016 Cockpit programme · ~~installing/chasing the next-WP Claude host hook~~ — **⊖ REMOVED by Amendment 3: the Claude host hook install and live proof is now IN SCOPE inside row 1.**
...
| **4** — WO-24 regenerated through `envelope.mjs` | **DONE** | `Deliverables/proofline/WO-2026-08-07-24-…` · Keel verdict **CLARIFY→ACCEPT** after Amendment 1 · **the first Keel order in four to survive read-back**, and the difference was the order, not the worker. |
...
**🎯 THE ONE CURRENT NEXT ACTION — dispatch VERITAS GATE 1 over the complete remaining functional scope (rows 1, 2 and 4) at the frozen head, per the § Veritas dispatch law above.**
...
**V4-9** · **C-1..C-9, C-11..C-15** · legacy `C:/.fusion247/larry-ding.mjs` · reminder-hook A/B/C product choice · ~~next-WP Claude host hook install~~ **⊖ UNPARKED by Amendment 3 — now inside row 1.**
