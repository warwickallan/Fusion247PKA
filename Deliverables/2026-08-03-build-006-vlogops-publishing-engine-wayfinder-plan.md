...
| **Migrations NOT applied** | **001, 002 have never reached the managed Supabase project.** Merging applied nothing. Phase PASS is withheld on that ground for both phases — this is capability proven on disposable clusters, **not** the human outcome. |
