...
//   · flag ON  -> the role-based policy governs (all required roles satisfied, not reviewer-blocked,
//     AND the typed merge lever clear: no current BLOCKS_CURRENT_MERGE finding and no classifier
//     finding missing its required_disposition — the latter fails closed). See migration 006.
//
