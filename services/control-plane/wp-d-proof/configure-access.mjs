...
// 2) READ-ONLY permissions on the shopping collections ONLY. Nothing on the Tower ledger.
...
// Deliberately NO permission rows for tower_review_log / tower_verdicts, and NO
// create/update/delete on anything -> denied by Directus default-deny.
